...
const ExplainConstraintPessimistic = (props) => (
    <Fragment>
        <p className="card-text"><code>{props.constraint.constraint}</code> is a <strong>pessimistic</strong> constraint. It means that it will match <strong>several versions</strong>.</p>
